...
namespace DesignAndAnimationLab.Common
{
    public static class VisualExtensions
    {
        ...
        public static bool GetIsBindCenterPoint(DependencyObject obj) => (bool)obj.GetValue(IsBindCenterPointProperty);

        public static string GetScale(DependencyObject obj) => (string)obj.GetValue(ScaleProperty);

        public static string GetTransations(DependencyObject obj) => (string)obj.GetValue(TransationsProperty);

        public static void SetIsBindCenterPoint(DependencyObject obj, bool value) =>
            obj.SetValue(IsBindCenterPointProperty, value);

        public static void SetScale(DependencyObject obj, string value) => obj.SetValue(ScaleProperty, value);
