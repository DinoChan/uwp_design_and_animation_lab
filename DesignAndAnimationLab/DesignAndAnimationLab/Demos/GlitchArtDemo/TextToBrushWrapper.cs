...
namespace DesignAndAnimationLab.Demos.GlitchArtDemo
{
    public class TextToBrushWrapper : Control
    {
        ...
        protected virtual void OnDashStyleChanged(CanvasDashStyle oldValue, CanvasDashStyle newValue) => DrawSurface();
        ...
        protected virtual void OnFontColorChanged(Color oldValue, Color newValue) => DrawSurface();
        ...
        protected virtual void OnOutlineColorChanged(Color oldValue, Color newValue) => DrawSurface();
        ...
        protected virtual void OnShadowBlurAmountChanged(double oldValue, double newValue) => DrawSurface();
        ...
        protected virtual void OnShadowColorChanged(Color oldValue, Color newValue) => DrawSurface();
        ...
        protected virtual void OnShadowOffsetXChanged(double oldValue, double newValue) => DrawSurface();
        ...
        protected virtual void OnShadowOffsetYChanged(double oldValue, double newValue) => DrawSurface();
        ...
        protected virtual void OnShowNonOutlineTextChanged(bool oldValue, bool newValue) => DrawSurface();
        ...
        protected virtual void OnStrokeWidthChanged(double oldValue, double newValue) => DrawSurface();
        ...
        protected virtual void OnTextChanged(string oldValue, string newValue) => DrawSurface();
