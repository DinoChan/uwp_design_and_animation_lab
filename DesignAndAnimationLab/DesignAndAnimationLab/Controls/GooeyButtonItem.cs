...
namespace DesignAndAnimationLab
{
    ...
    public sealed class GooeyButtonItem : Button
    {
        ...
        private void OnLoaded(object sender, RoutedEventArgs e) => UpdateItemPropertyCore();

        private void OnSizeChanged(object sender, SizeChangedEventArgs e) => OnGooeyButtonItemPropertyChanged();
        ...
        public static readonly DependencyProperty Win2DTranslateXProperty =
            DependencyProperty.Register("Win2DTranslateX", typeof(double), typeof(GooeyButtonItem),
                new PropertyMetadata(0d, (s, a) =>
                {
        ...
        public static readonly DependencyProperty Win2DTranslateYProperty =
            DependencyProperty.Register("Win2DTranslateY", typeof(double), typeof(GooeyButtonItem),
                new PropertyMetadata(0d, (s, a) =>
                {
                    if (s is GooeyButtonItem sender)
                    {
        ...
        {
            internal GooeyButtonItemPropertyChangedEventArgs(GooeyButtonItemProperty property) => Property = property;
